...
//  digitalWrite(probe, 0);     // stop the probe
  ...
  digitalWrite(decharge, 0);    // bring it low to start de-charging of C1
  PPS_ReadFlag = true;
  delayMicroseconds(20);        // allow sufficient time to fully drain the capacitor
...
void printHeader2_ToSerial()
{
  ...
  Serial.print(F("Rev. 3.5.1 paulv mods")); // paulv: added my mod indication
...
void setup() 
{
  ...
  analogWrite(fan_pin,125); // kick_start the fan at approx. half speed
